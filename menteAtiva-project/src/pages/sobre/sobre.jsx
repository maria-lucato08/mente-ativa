        ...
        <div className={style.conteudo}>
          <section className={style.card}>
            <div className={style.texto}>
              ...
              <p>
                O Mente Ativa nasceu para ajudar estudantes do ensino médio a
                desenvolverem todo o seu potencial, oferecendo conteúdos claros,
                dinâmicos e de qualidade sobre as diversas disciplinas, além de
          ...
          <section className={style.card}>
            <h2 className={style.titulo}>🚀 Como realizamos nosso objetivo?</h2>
            <p>
              Trabalhamos com conteúdos claros, dinâmicos e de qualidade sobre
              as diversas disciplinas, além de preparar para o ENEM. Queremos
              transformar o aprendizado em uma experiência motivadora e
              acessível.
            </p>
          </section>
